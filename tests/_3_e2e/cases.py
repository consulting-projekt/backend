...
test_cases = [
    ...
    },
    {
        "vars": {
            ...
            "start": None,
            "answer": "Von wo möchtest du starten? Dann nennen können wir dir die nächste Verbindung nennen."
        }
    },
    {
		"vars": {
            ...
            "start": "Lukmoor",
			"answer": "Die nächste Verbindung von <START> nach <DEST> fährt am <DATE> um <TIME>."
	    }
    },
    {
		"vars": {
            ...
            "start": None,
			"answer": "Von wo möchtest du starten? Dann berechnen wir dir gerne die Route nach <DEST> am <DATE> um <TIME>."
	    },
	},
    {
		"vars": {
            ...
            "start": None,
			"answer": "Von wo möchtest du starten? Dann berechnen wir dir gerne die Route nach <DEST> um <TIME> am <DATE>."
		}
	},
	{
		"vars": {
            ...
            "start": "Hochrad",
			"answer": "Der nächste Bus von <START> nach <DEST> fährt am <DATE> um <TIME>."
		}
	},
	{
		"vars": {
	...
	},
	{
		"vars": {
            ...
            "start": "Flughafen",
			"answer": "Die nächste Verbindung von <START> nach <DEST> fährt um <TIME>."
		}
	},
	{
		"vars": {
