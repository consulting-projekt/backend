...
test_cases = [
	...
	},
	{
		"vars": {
			...
			"answer": "Der nächste Zug von <START> nach <DEST> fährt am <DATE> um <TIME>."
		}
	},
	{
		"vars": {
	...
	},
	{
		"vars": {
			...
			"answer": "Der nächste Bus von <START> nach <DEST> fährt am <DATE> um <TIME>. Bitte stelle eine weitere Routenanfrage als separate Nachricht."
		}
	},
	{
		"vars": {
