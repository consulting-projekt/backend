...
from db.utils_llm import call_mixtral, call_gemma3_4b, get_answer_json
...
def call_api(prompt, options, context):
    ...
    params_extract_res = get_answer_json(call_mixtral(prompt))
    ...
    if len(problems) > 0:
        ...
        return {
            "output": {
                "answer": get_answer_json(call_mixtral(prompt)),
                "vars": {
                    "start": start,
                    "dest": dest,
